...
use todoListAdvance\Models\TodoList;
...
<body>
    ...
    if (!empty($tasks)) {
        echo '  <h2 class="displayListBt"> danh sách công việc</h2>';
        ...
        echo "<h2> danh sách công việc bạn trống </h2>";
    }
    ?>
    <div class="">
    ...
    <div style="display: flex;" class="">
        <div class="">
            <form style="padding: 10px;" action="" method="POST">
                <h2> Tìm công việc theo title </h2>
        ...
        <div class="">
            <form style="padding: 10px;" action="" method="POST">
                <h2> lọc công việc theo độ ưu tiên</h2>
